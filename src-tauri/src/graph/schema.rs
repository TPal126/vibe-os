...
DEFINE FIELD IF NOT EXISTS last_indexed   ON repo TYPE option<datetime>;
DEFINE FIELD IF NOT EXISTS created_at     ON repo TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON repo TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON module TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON module TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON fn_def TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON fn_def TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON class TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON class TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON ticket TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON ticket TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON skill TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON skill TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON decision TYPE datetime;
DEFINE FIELD IF NOT EXISTS updated_at     ON decision TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON action TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS created_at     ON test TYPE datetime;
...
DEFINE FIELD IF NOT EXISTS started_at     ON session TYPE datetime;
